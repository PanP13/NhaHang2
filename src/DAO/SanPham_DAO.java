...
public class SanPham_DAO {
    ...
    public List<SanPham> searchSP(String s, int t){
        ...
        String sql="SELECT * FROM SANPHAM";
        switch(t){
            case 0: sql = "SELECT * FROM SANPHAM WHERE MASP LIKE '%"+s+"%'"; break;
            case 1: sql = "SELECT * FROM SANPHAM WHERE TENSP LIKE '%"+s+"%'"; break;
            case 2: sql = "SELECT * FROM SANPHAM WHERE DONGIA="+s; break;
            case 3: sql = "SELECT * FROM SANPHAM WHERE MALSP LIKE '%"+s+"%'"; break;
            default: break;
        }
